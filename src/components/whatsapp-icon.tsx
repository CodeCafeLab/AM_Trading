...
const WhatsAppIcon = () => {
    return (
        ...
        >
            <Button
                size="icon"
                className="bg-[#25D366] hover:bg-[#128C7E] rounded-full w-10 h-10 shadow-xl flex items-center justify-center transition-transform duration-300 group-hover:scale-110"
            >
                <svg
                    role="img"
                    viewBox="0 0 24 24"
