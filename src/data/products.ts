...
export const products = [
  ...
  { 
    ...
    details: 'To protect sensitive IT infrastructure and maintain seamless operations for this corporate client, we installed a synchronized pair of 250 kVA Cooper Corp generators. The system is governed by a smart controller that manages load sharing and automatic failover. Our team handled the rooftop installation, including custom sound attenuation enclosures and fuel delivery systems, ensuring minimal disruption to the client\'s daily business.'
  },
  { 
    id: '3',
  ...
  { 
    ...
    details: 'This versatile solution provides on-demand power anywhere it\'s needed. The vehicle is equipped with a super-silenced 82.5 kVA Cooper Corp generator, integrated distribution panels with multiple outlet types, and extensive onboard cabling. We custom-built the van to be highly maneuverable and quick to set up, making it the perfect rental solution for event management companies and film crews requiring reliable remote power.'
  },
  { 
    id: '8',
  ...
  { 
    ...
    details: 'For this hospitality client, maintaining guest comfort was paramount. We installed a 350 kVA silent generator to power all resort facilities, from guest rooms and restaurants to swimming pools and event halls. The automatic transfer switch is configured for a "no-break" transfer, ensuring that even sensitive electronic equipment like POS systems and servers remain online during the switchover.'
  },
  { 
    id: '11',
  ...
  { 
    ...
    details: 'This project for a luxury brand showroom required a power solution that was both reliable and discreet. We installed a 62.5 kVA generator on the building\'s service terrace with a custom exhaust system to minimize noise and visual impact. The generator ensures that the showroom\'s specific lighting design and climate control are maintained during power cuts, preserving the high-end customer experience.'
  },
  { 
    id: '13',
    ...
    details: 'We provided a complete power backup solution for an educational campus, covering classrooms, laboratories, the library, and administrative offices. The 100 kVA generator was installed in a dedicated, secure enclosure away from student areas. Safety and reliability were our top priorities, ensuring a conducive learning environment is maintained at all times.'
  },
  { 
    id: '14',
    ...
    details: 'Continuous operation is vital for a petrol pump. We installed a durable 40 kVA generator compliant with all petroleum industry safety standards. The system powers all critical equipment, including the fuel dispensers and digital payment systems, ensuring the station remains fully operational and profitable around the clock, even during extended power outages.'
  },
  { 
    id: '15',
    ...
    details: 'Powering heavy machinery requires generators built to handle intense load fluctuations. We supplied a specialized 150 kVA generator with a robust engine and alternator to power a construction lift and tower crane. The unit was delivered to the site and commissioned by our expert team, ensuring safe and reliable vertical transportation of materials and personnel throughout the construction project.'
  },
  { 
    id: '16',
    ...
    details: 'Modern digital cinema equipment is highly sensitive to power fluctuations. We installed a 200 kVA generator with an Automatic Voltage Regulator (AVR) to provide clean and stable power, protecting the theater\'s expensive equipment. The seamless backup ensures that the movie experience is never interrupted for paying customers, safeguarding the theater\'s revenue and reputation.'
  },
];
